...
- strategy
collection: displays
helpscout_url: https://help.privy.com/article/142-use-liquid-in-conversion-javascript
keywords:
- Conversion JS
- Custom Code
- Liquid
...
- custom id
- redirect
name: Use Liquid in Conversion JavaScript
slug: use-liquid-in-conversion-javascript
---
Privy supports the use of Liquid variables in your custom conversion
JavaScript (JS). These variables allow you to inject information related to a
signup event, including contact and display information, into your custom JS
code.
...
Liquid variables and their associated attribute values are included in your
code by applying a specific format to the custom JavaScript snippet. Typical
use cases include:

### Print to console

![](https://hf-files-
oregon.s3.amazonaws.com/hdpprivy_kb_attachments/2023/12-15/0c0fb103-4b9e-4dc0-81cf-c15a96f83c2c/image-0.png)

​If a user named "Joe Smith" with the email "joesmith@example.com" just signed
up, the above code will print "Joe Smith (joesmith@example.com) just signed
up!" to the console.

### Redirect and pass a variable value

![](https://hf-files-
oregon.s3.amazonaws.com/hdpprivy_kb_attachments/2023/12-15/cd4c847d-5cce-4d04-9487-09dc938a39db/image-1.png)

The above code will redirect the user after signing up and pass the display id
as a URL parameter to the new page.
