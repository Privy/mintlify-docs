...
<Tip>
  Not sure how to create an Abandoned Cart Series in Privy? [Here's a step-by-step guide.](https://privy.mintlify.app/docs/learn/automations/abandoned-cart-email)
</Tip>

## Welcome Emails

You only have one chance at a first impression, and when someone first signs up for your list, a [Welcome series](https://privy.mintlify.app/docs/learn/automations/welcome-email) is the perfect opportunity to introduce your products, shop, and mission. People buy from people, and by establishing trust and a relationship with your audience early on, they’ll be more likely to purchase from you in the future.&#x20;
...
<Tip>
  Not sure how to create a Welcome Series in Privy? [Here's a step-by-step guide.](https://privy.mintlify.app/docs/learn/automations/welcome-email)
</Tip>
...
<Tip>
  Not sure how to create a Purchase Follow-Up email in Privy? [Here's a step-by-step guide.](https://privy.mintlify.app/docs/learn/automations/purchase-follow-up)
</Tip>

## Customer Winback Emails

Did you know that repeat customers created as a result of your actions are 9x more likely to convert, spend 3x your average order value, and are 20% more profitable for your business? That is why customer retention is so important and having an active [Customer Winback series](https://privy.mintlify.app/docs/learn/automations/customer-winback) is crucial.

**A good Customer Winback series:**

<Icon icon="face-smile-hearts" /> Makes your customer feel noticed and appreciated by [using their first name](https://privy.mintlify.app/docs/learn/content/personalization-tags#using-merge-tags).
...
<Tip>
  Not sure how to create a Customer Winback email in Privy? [Here's a step-by-step guide.](https://privy.mintlify.app/docs/learn/automations/customer-winback)
</Tip>