...
* **Tiered discounts:** Consider a tiered abandoned cart strategy, where you offer a certain discount to "low value" carts and another discount to "high value" carts. For example, maybe carts under &dollar;75 get 10% off, but carts over &dollar;75 get &dollar;10 off.
