...
* Navigate to 
  ...
  [Automations](https://dashboard.privy.com/automations)
...
* [Add more emails](https://help.privy.com/docs/learn/automations/purchase-follow-up#add-remove-emails)

   and 

  [customize your templates.](https://help.privy.com/docs/learn/automations/purchase-follow-up#customize-your-templates)
...
* Offering a discount? Make sure you attach the code under 
...
2. [Personalize the subject line and/or email body](https://help.privy.com/docs/learn/content/personalization-tags#personalizing-emails)
