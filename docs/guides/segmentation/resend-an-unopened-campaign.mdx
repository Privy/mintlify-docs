...
1. Head to [Contacts > Segments](https://dashboard.privy.com/segments) and click **Create Segment** in the upper right corner.

2. Give your segment a name.

3. Select the *Choose category* dropdown and choose **Did not open** from the menu.

4. Select "**a campaign**" from the following dropdown menu.

5. Lastly, choose the campaign you’d like to retarget.

6. Add any other conditions if you’d like, then click **Create.**
