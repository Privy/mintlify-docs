...
Privy makes it easy to target your audience using [Smart Segments](https://help.privy.com/docs/learn/email-campaigns/segmentation#smart-segments) — these are pre-built and ready for you to start using in your account today. Below are the (4) available Smart Segments offered by Privy today, as well as a couple ideas for what kinds of messaging would work well with them!
...
Smart Segments are a great place to start, but you can level up segmentation by building Custom Segments for your business based on a combination of Shopping Activity, Customer Attributes, Website Activity, and/or Email Engagement. Checkout our [Advanced Segments guide](https://help.privy.com/docs/guides/segmentation/advanced-segments) to learn 4 great segments you can customize for your unique business.