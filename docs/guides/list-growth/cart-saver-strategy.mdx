...
<Note>
  This strategy guide is going to focus mainly on the targeting you should use, and examples to follow — if you need more step-by-step guidance on how to create a display in Privy, [please follow this guide.](https://help.privy.com/docs/learn/displays/create-a-display)
</Note>
...
<video autoPlay muted loop playsInline className="cart-saver-template" src="/images/strategy-guides/cart-saver-create.mp4" />
...
<video autoPlay muted loop playsInline className="cart-saver-settings" src="/images/strategy-guides/cart-saver-exit-intent.mp4" />
...
<img height="200" src="/images/strategy-guides/cart-saver-targeting.png" />
...
<img height="200" src="/images/strategy-guides/cart-saver-examples.png" />
