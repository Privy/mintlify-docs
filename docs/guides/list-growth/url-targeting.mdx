...
1.  Target a display to appear on certain product or collection pages.
2.  Restrict a display from appearing on certain pages.
3.  Target visitors coming from social media, such as Instagram.
4.  Target visitors coming from ads or influencer links.
...
<img
  height="200"
  src="/images/strategy-guides/initial-url-social-media.png"
/>
