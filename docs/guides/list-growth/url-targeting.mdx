...
<AccordionGroup>
  <Accordion title="Contains / Does not contain">
    ...
    _For example, the following targeting condition will show the display to any URL containing _\*\*\_ in the URL, including \_`https://example-store.com/shirts/plain-white-tee`
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Collections">
    ...
    This will allow the display to appear on any pages containing the collection name in the URL. This includes browsing the collection pages _and_ any specific products which are part of that collection.
  </Accordion>
