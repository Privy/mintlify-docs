...
One of Privy’s most powerful capabilities is our URL Audience Targeting for displays. Tailoring your displays based on your visitor's source or current location on your website can give you more control over your onsite experience and conversion rate; with URL Targeting, there's no need to take a shot in the dark — you understand exactly where you're meeting your traffic, and how to approach them.

There’s a whole world of possibilities when it comes to targeting by URL, so in this article we will break down the basics of each condition, and walk through 4 common scenarios in which it’s used:
...
There may be displays that you want to prevent from showing on certain pages, such as your Cart page, your Homepage, or your About Us page.
...
<img
  height="200"
  src="/images/strategy-guides/url-does-not-contain.png"
/>
...
<img
  height="200"
  src="/images/strategy-guides/url-is-not-homepage.png"
/>

### Target traffic from social media

To better measure your conversion from social channels and/or to show your social media traffic a special display or incentive, you will want to use the **Initial URL (this session)** property and select **Contains** as your operator.
...
<img
  height="200"
  src="/images/strategy-guides/initial-url-social.png"
/>
...
<img
  height="200"
  src="/images/strategy-guides/utm-social-media.png"
/>

To prevent your social media traffic from seeing more than one popup upon landing on your site, remember to exclude them from seeing your regular Welcome Display. To achieve this, head to your regular Welcome Display's *Settings* and add the following targeting condition with your social media in the Value field:

<img
  height="200"
  src="/images/strategy-guides/exclude-social.png"
/>
...
<img
  height="200"
  src="/images/strategy-guides/utm-google-ad.png"
/>
...
<img
  height="200"
  src="/images/strategy-guides/utm-influencer.png"
/>