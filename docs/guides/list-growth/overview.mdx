...
<Card title="URL Targeting" icon="bullseye-arrow" href="/docs/guides/list-growth/url-targeting">
  Take control of your onsite experience: use URL Targeting to determine which pages your displays appear on, and target visitors based on how they landed on your site.
</Card>