...
* Click 
  ...
  **Add Step**
   ...
   at the bottom of the display builder and select either 
...
* Click 
  ...
  **Add Step**
   ...
   at the bottom of the display builder and select 
...
* Add 1 Text Box and 2 Buttons.
  ...
  * Select your first button and edit the on-click action to 

    **Transition to: next display.**

     Edit the text to reflect a visitor accepting your offer.

  * Select your second button and edit the on-click action to 

    **Close Display.**

     Edit the text to reflect a visitor declining the offer.
