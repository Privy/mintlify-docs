...
<img height="200" src="/images/strategy-guides/personalize-vip.png" />
...
Here's some great examples that drive urgency and/or show gratitude based on the last time someone placed an order:

<img height="200" src="/images/strategy-guides/order-date-examples.png" />
