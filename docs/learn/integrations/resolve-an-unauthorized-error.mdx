...
<img height="200" src="/images/integrations/test-connections.png" />
...
<video autoPlay muted loop playsInline className="sync-integration-rule" src="/images/integrations/add-sync-rule.mp4" />