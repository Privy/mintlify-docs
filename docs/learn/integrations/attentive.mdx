...
description: "Learn how to connect Privy <> Attentive and start syncing new contacts."
---
...
<img height="200" src="/images/integrations/attentive-available-integrations.png" />
...
<img height="200" src="/images/integrations/attentive-display-example.png" />
...
<video autoPlay muted loop playsInline className="sync-integration-attentive" src="/images/integrations/add-sync-rule.mp4" />

Click **Add Integration** and select your Attentive account from the menu. Input your Attentive Source ID and then click **Save**.

<img height="200" src="/images/integrations/attentive-source-id.png" />
...
<img height="200" src="/images/integrations/attentive-remove-integration.png" />
...
<img height="200" src="/images/integrations/attentive-revoke-permissions.png" />
