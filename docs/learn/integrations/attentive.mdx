...
3. Locate your Attentive integration under the *Authorized Integrations* section and select the **Delete** icon.

4. In Attentive, navigate to the [Connected Apps](https://ui.attentivemobile.com/settings/connected-apps) section of your account settings and select the **Revoke Application** option next to Privy. Confirm your decision in the prompt. 
