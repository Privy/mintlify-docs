...
3. Enter your email address and Personal Access Token from Emotive, then click **Link Account**.
...
2. Locate your Emotive integration under the _Authorized Integrations_ section and select the **Delete** icon.