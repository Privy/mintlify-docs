...
2. Collect the "Coupon" Profile Attribute in your display's settings

To attach your coupon code to your display and collect the "Coupon" Profile Attribute:

- Head to your display's **Settings**.
- Select the **Coupon** card and choose the desired coupon code from the dropdown menu.
- Next, select **Show Advanced Settings** in the lower left.
