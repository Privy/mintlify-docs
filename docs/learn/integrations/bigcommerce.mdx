...
<img height="200" src="/images/integrations/bigcommerce-install-privy-app.gif" />
...
<img height="200" src="/images/integrations/bigcommerce-blueprint.png" />

*  In the new window, find and select the **Header.html** section from the sidebar.

<img height="200" src="/images/integrations/add-code-to-header.png" />
...
<img height="200" src="/images/integrations/install-via-script-manager.gif" />
