...
<Card title="Understanding Deliverability" icon="sparkles" horizontal={true} href="https://privy.mintlify.app/docs/learn/deliverability/understanding-deliverability">
...
<Card title="Tips to Improve Deliverability" icon="chart-line-up" horizontal={true}>
...
<Card title="Use a custom sending domain" icon="paper-plane" href="https://privy.mintlify.app/docs/learn/deliverability/use-a-custom-sending-domain">
...
<Card title="DMARC / SPF / DKIM Authentication" icon="badge-check" href="https://privy.mintlify.app/docs/learn/deliverability/understanding-email-authentication">
...
<Card title="Warm up a sending domain" icon="fire-flame-curved" href="https://privy.mintlify.app/docs/learn/deliverability/warming-up-sending-domain">
...
<Card title="Hard Bounces vs. Soft Bounces" icon="circle-question" href="https://privy.mintlify.app/docs/learn/deliverability/hard-vs-soft-bounces">
...
<Card title="Understanding Non-Human Interactions in Email Marketing" icon="robot" href="https://privy.mintlify.app/docs/learn/deliverability/understanding-non-human-interactions">
