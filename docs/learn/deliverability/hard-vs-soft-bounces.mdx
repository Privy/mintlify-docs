...
We have an [article](https://help.privy.com/docs/learn/deliverability/understanding-email-authentication) that goes into more detail about email authentication, but you can also reach out to us for extra help by sending an email to [support@privy.com](mailto:support@privy.com).
