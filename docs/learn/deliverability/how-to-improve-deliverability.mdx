...
<AccordionGroup>
  ...
  <Accordion title="Warm up your domain." defaultOpen={false}>
    For new domains, or domains that have recently added authentication records (DMARC/DKIM/SPF), it’s important to [warm up your domain](https://help.privy.com/docs/learn/deliverability/warming-up-sending-domain) so that major inbox providers such as Google and Yahoo can detect the progression of your domain’s reputation.
  ...
  <Accordion title="Practice list hygiene." defaultOpen={false}>
    Maintaining a clean and updated list is essential for good delivery and deliverability rates. Periodically removing bots, invalid, and bounced addresses can make a huge difference in your delivery and help maintain a good sending reputation. [Learn how to practice list hygiene in Privy.](https://help.privy.com/docs/learn/contact-management/list-hygiene)
  </Accordion>
  ...
  <Accordion title="Be mindful of your email content." defaultOpen={false}>
    ...
    * Personalize your emails with [merge tags](https://help.privy.com/docs/learn/content/personalization-tags). For example, include the contact's first name.
...
<AccordionGroup>
  ...
  <Accordion title="Bounced" defaultOpen={false}>
    The percentage of emails that resulted in a soft or hard bounce compared to the total number of emails sent. [Learn more about Hard vs. Soft Bounces. ](https://help.privy.com/docs/learn/deliverability/hard-vs-soft-bounces)
  </Accordion>
</AccordionGroup>
...
<Tip>
  ...
  * [Campaigns Reporting](https://help.privy.com/docs/learn/email-campaigns/email-campaign-reporting#individual-campaign-reporting)

  * [Automations Reporting](https://help.privy.com/docs/learn/automations/automations-reporting#individual-automations-reporting)
</Tip>
