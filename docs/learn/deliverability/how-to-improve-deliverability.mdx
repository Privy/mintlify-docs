...
sidebarTitle: "Improving Deliverability"
icon: "sparkles"
---
...
<AccordionGroup>
  ...
  <Accordion title="Spam Rate" defaultOpen={false}>
    ...
    <Icon icon="triangle-exclamation" /> **Note:** Not all providers relay spam complaints to email service providers, so the number you see in your reports is the baseline of received complaints and is usually lower than the actual number.
  </Accordion>
</AccordionGroup>
...
<video autoPlay muted loop playsInline className="dashboard-deliverability-reporting" src="/images/deliverability/find-deliverability-card.mp4" />
...
<Tip>
  ...
  * [Campaigns Reporting](https://privy.mintlify.app/docs/learn/email-campaigns/email-campaign-reporting#individual-campaign-reporting)

  * [Automations Reporting](https://privy.mintlify.app/docs/learn/automations/automations-reporting#individual-automations-reporting)
</Tip>
