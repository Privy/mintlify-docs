...
* Verify email addresses and use [double opt-in](https://help.privy.com/docs/learn/contact-management/double-opt-in) methods.

**Low Engagement:**

* [Segment](https://help.privy.com/docs/learn/email-campaigns/segmentation) your audience further for more targeted and personalized campaigns.
