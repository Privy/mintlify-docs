...
Shopify has implemented a billing cap of $5,000. This means that if the cost of your subscription plan increases to $5,000, you must manually approve Shopify has implemented a billing cap of $5,000. 
