...
Shopify separates the base charge of a plan from any additional pricing associated with specific usage tiers. For example, a merchant on the $90 Starter Plan will see a base charge of &dollar;15 and a usage charge of &dollar;75.
...
Your account could face restrictions if you have not accepted a change in pricing in your Shopify dashboard. This could happen if your pricing exceeds the cap set on your account, which means you need to manually approve the charge beyond your billing cap. Even if your billing cap isn't set at the maximum amount of $5,000, your account could still face restrictions. In such cases, a pop-up message will appear on your dashboard when attempting to edit or create any display or campaign:
