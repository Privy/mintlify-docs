...
Shopify has implemented a billing cap of $5,000. This means that if the cost of your subscription plan increases to $5,000, you must manually approve Shopify has implemented a billing cap of $5,000. This means that if the cost of your subscription plan increases to $5,000, you must manually approve the new price to avoid potential account restrictions.
...
The $5,000 billing cap safeguards against sudden and significant price increases, ensuring a smooth transition between the plan tiers. 
