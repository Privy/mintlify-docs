...
Shopify has implemented a billing cap of $5,000. This means that if the cost of your subscription plan increases to $5,000, you must manually approve the new price to avoid potential account restrictions.
...
<img height="200" src="/images/account-settings/shopify-spend-limit.png" />
...
If you plan to stop using the account for a period of time, we recommend that you cancel it to avoid additional charges. For more information, see [this article.](https://privy.mintlify.app/docs/learn/account-settings-and-billing/account-settings/manage-your-plan)
