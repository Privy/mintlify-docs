...
<img height="200" src="/images/email-settings/sender-options.png" />
...
<img height="200" src="/images/email-settings/sender-name-example.png" />
...
<Tip>
  For more information on how to set up your sending domain, and why it's so important, please reference [this guide](https://help.privy.com/docs/learn/deliverability/use-a-custom-sending-domain).
</Tip>

<img height="200" src="/images/email-settings/sender-email-example.png" />
...
<img height="200" src="/images/email-settings/business-address-example.png" />
