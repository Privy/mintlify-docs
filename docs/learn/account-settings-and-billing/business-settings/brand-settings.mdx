...
* Select your desired font from the available options. As noted - only some fonts are considered web-safe and appear consistently in emails. Learn more about email fonts [here](https://privy.mintlify.app/docs/learn/content/web-safe-fonts).
