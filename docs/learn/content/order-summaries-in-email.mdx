...
* Drag and drop the **Order** block from the *Content* menu on the left side. **Save.**

<video autoPlay muted loop playsInline className="insert-order-summary" src="/images/content/add-order-summary.mp4" />
