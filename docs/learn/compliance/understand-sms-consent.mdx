...
<Note>
  When you add a phone number form field with the SMS Opt-In disclaimer, be sure that you add your brand's Privacy Policy and Terms of Service.

  \
  To do this, click on the SMS Opt-In disclaimer element, and paste the links to your own Privacy link and Terms link into the fields on the right:
