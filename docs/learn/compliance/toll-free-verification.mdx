...
<Card title="Build consumer trust" icon="handshake">
...
<Card title="Reduce chances of being filtered by carriers" icon="filter">
...
<Card title="Ensure better delivery rates" icon="inbox">
...
<Icon icon="circle-question" /> **What happens after I submit my application?**
...
<Icon icon="circle-question" /> **What can I do while my verification is in 'pending' status?**
...
<Icon icon="circle-question" /> **What should I do once my verification is approved?**
...
<Card title="Restricted Industries" icon="ban-smoking">
...
<Card title="Incomplete or unpublished product catalog" icon="bars-staggered">
...
<Card title="Website is password protected or unpublished" icon="lock">
