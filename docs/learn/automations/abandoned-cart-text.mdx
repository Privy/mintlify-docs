...
<img height="200" src="/images/automations/example-ace-text.png" />

**Before you get started...**

Please review the following:

<Icon icon="check" /> You must be on our Growth Plan. You need to have an [approved toll-free number](https://help.privy.com/docs/learn/compliance/toll-free-verification) and [textable contacts](https://help.privy.com/docs/learn/compliance/understand-sms-consent).
...
<video autoPlay muted loop playsInline className="create-ac-text" src="/images/automations/create-abandoned-cart-text.mp4" />
...
<video autoPlay muted loop playsInline className="write-ac-text" src="/images/automations/write-abandoned-cart-text.mp4" />

## Edit your settings

Scroll to find, edit, and save your Trigger and Coupon settings:

<video autoPlay muted loop playsInline className="edit-ac-text-settings" src="/images/automations/abandoned-cart-text-settings.mp4" />
...
<img height="200" src="/images/automations/activate-abandoned-cart-text.png" />
...
After you activate your Abandoned Cart Text, you can [review its performance](https://help.privy.com/docs/learn/automations/automations-reporting) at any time.
...
<video autoPlay muted loop playsInline className="deactivate-ac-text" src="/images/automations/deactivate-abandoned-cart-text.mp4" />
