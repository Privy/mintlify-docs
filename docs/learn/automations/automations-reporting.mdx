...
<AccordionGroup>
  ...
  <Accordion title="Bounced" defaultOpen={false}>
    The number of contacts which were sent the email and had the email bounce back. [Learn more about bounces here.](https://help.privy.com/docs/learn/deliverability/hard-vs-soft-bounces)
  </Accordion>
...
<Info>
  For more information on how Privy's attribution model works, [check out this FAQ article](https://help.privy.com/docs/learn/email-campaigns/privy-attribution-model).
</Info>
