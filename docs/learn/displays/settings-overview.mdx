...
<Note>
  Your Coupon must be created in Privy in order to be attached to your display. [Learn more about creating and managing Coupons in Privy.](https://privy.mintlify.app/docs/learn/content/coupon-codes)
</Note>
...
Choose between **Single Opt-In** and **Double Opt-In** for your display. *Single Opt-In is the default setting for each Privy template.* Choosing Double Opt-In is encouraged for building a high quality, engaged list; it requires new sign ups to confirm their subscription in their inbox. [Learn more.](https://privy.mintlify.app/docs/learn/contact-management/double-opt-in)

### Sync Integrations

<img height="200" src="/images/displays/sync-integrations-settings.png" />

If you are using an external email service provider and/or need to sync your sign ups to one of your Linked Accounts, make sure you add all necessary sync rules to your display(s) here. [Learn more about our supported Integrations.](https://privy.mintlify.app/docs/learn/integrations/overview-integrations)
...
Detected attributes appear on [individual contact records](https://privy.mintlify.app/docs/learn/contact-management/view-and-filter-contacts#viewing-individual-contacts), in [contact exports to CSV](https://privy.mintlify.app/docs/learn/contact-management/export-contacts#export-contacts-to-csv), and in your Linked Account's data (if you are syncing sign ups to a third party).
