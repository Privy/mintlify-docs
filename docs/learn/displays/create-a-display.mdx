...
<Info>
  For help creating display types such as [Spin To Win](https://privy.mintlify.app/docs/learn/displays/classic-designer/spin-to-win), [Landing Pages](https://privy.mintlify.app/docs/learn/displays/classic-designer/landing-page), and [Embedded Forms](https://privy.mintlify.app/docs/learn/displays/classic-designer/embedded-form), please reference their dedicated resources.
</Info>
