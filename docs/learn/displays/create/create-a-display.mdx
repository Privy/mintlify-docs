...
<Card title="Edit each step of your display">
  You can jump between your Popup, Thank You Page, and Tab using the bar at the bottom of your screen. You can also preview your display on both desktop and mobile here.
</Card>

To save time, use the "Match Styles Functionality" tool to copy size, layout, font styles, and colors between your display's steps.
...
<video
  ...
  src="/images/displays/match-styles.mp4"
></video>
...
<video
  ...
  src="/images/displays/add-element.mp4"
></video>
...
<video
  ...
  playsInline
  className=add-step"
  src="/images/displays/add-step.mp4"
></video>
...
<video
  ...
  loop
  playsInline
  className="after-signup"
  src="/images/displays/publish-aftersignup.mp4"
></video>
