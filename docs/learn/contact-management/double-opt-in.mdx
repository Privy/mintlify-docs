...
[Check out this guide](https://help.privy.com/docs/learn/compliance/understand-sms-consent) for more details on SMS Consent and how Double Opt-In works for Privy Text.
