...
<img height="200" src="/images/contact-management/single-vs-double-opt-in.png" />
...
<img height="200" src="/images/contact-management/unset-double-opt-in.png" />
...
<video autoPlay muted loop playsInline className="enable-double-opt-in" src="/images/contact-management/enable-double-opt-in.mp4" />
...
<img height="200" src="/images/contact-management/double-opt-in-email.png" />
...
Along with Double Opt-In for email sign ups, Privy also uses Double Opt-In for SMS sign ups. If you are on our Growth Plan and you're collecting SMS contacts, your new sign ups must reply 'Y' to their Double Opt-In text message in order to become textable. You can preview your Double Opt-In text message in your [Text Settings](https://dashboard.privy.com/settings/text-settings) page within your dashboard.

[Check out this guide](https://privy.mintlify.app/docs/learn/compliance/understand-sms-consent) for more details on SMS Consent and how Double Opt-In works for Privy Text.
...
<img height="200" src="/images/contact-management/double-opt-in-thank-you-page.png" />