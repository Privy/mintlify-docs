...
2. <a href="#import-via-linked-account" >During an import via Linked Account</a>

3. <a href="#create-contacts-manually" >Manually adding a contact via the Contacts dashboard</a>

4. <a href="#create-contacts-during-checkout" >During the checkout process</a> *(Shopify + Weebly stores)*
