...
Privy will not create any duplicate contacts — the existing contact profile will be updated, and new order activity will be added to the existing profile.
...
* In the contact profile, click on the Delete contact option in the upper right corner.