...
* Delete obviously fake email addresses or [bots](https://help.privy.com/docs/learn/contact-management/remove-bots)
...
<Info>
  By default, Privy does not allow the creation of duplicate contact profiles. Privy also automatically unsubscribes contacts which we can identify have marked your emails as spam, and we also practice [auto-rejection](https://help.privy.com/docs/learn/compliance/contact-auto-rejection) for any role-based addresses that violate CAN-SPAM. All of these practices are in place to keep your business compliant + help keep your list as healthy as possible.
</Info>
...
Once you download the CSV, filter out any 'email-opened' or 'email-clicked' activity (to exclude contacts that engaged with your email). [Import the remaining contacts into Privy as unsubscribed.](https://help.privy.com/docs/learn/contact-management/unsubscribe-contacts#bulk-unsubscribe)
