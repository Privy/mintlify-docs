...
2. <a href="#edit-your-campaign-details">Send one-time emails to all of your contacts, or a segment of your audience.</a>
...
<video autoPlay muted loop playsInline className="new-campaign" src="/images/email-campaigns/create-new-campaign.mp4" />
...
<video autoPlay muted loop playsInline className="new-template" src="/images/email-campaigns/choose-a-template.mp4" />

* Once you select your template, you can [use our drag and drop editor](https://help.privy.com/docs/learn/email-campaigns/email-templates) to customize the design.
...
<img height="200" src="/images/email-campaigns/email-name.png" />

### Recipients

Under the **"To"** section, click the 'edit' icon to select which contacts you'd like to send your campaign to.&#x20;

You can send to All Contacts, or you can select a [Custom or Smart Segment](https://help.privy.com/docs/learn/email-campaigns/segmentation) to target your email to a specific group of your list. You also have the option to exclude a segment from receiving your email under **"Don't send to"**.

Click **Done** to save your changes.

<img height="200" src="/images/email-campaigns/recipients.png" />
...
<img height="200" src="/images/email-campaigns/sender-details.png" />

<Note>
  **Note:** To update the default From Name and Address used for your emails, navigate to the *Sender Options* section of your [account settings](https://dashboard.privy.com/settings/email). Additionally, consider [updating your sending domain](https://help.privy.com/docs/learn/deliverability/use-a-custom-sending-domain) so you can use custom addresses associated with your domain and improve your deliverability. 
</Note>
...
<img height="200" src="/images/email-campaigns/subject-line.png" />

### Coupon

If you're using a [Coupon merge tag](https://help.privy.com/docs/learn/content/coupon-codes#email-campaigns) in your Campaign, make sure that you attach your coupon code here. Click the 'edit' icon, select the desired coupon from the dropdown menu, and click **Done** to save your changes.

<img height="200" src="/images/email-campaigns/campaign-coupon.png" />
...
<video autoPlay muted loop playsInline className="test-email" src="/images/email-campaigns/preview-test-email.mp4" />
...
<img height="200" src="/images/email-campaigns/send-or-schedule.png" />

1. To send your campaign immediately, press the **Send** button and **Confirm** your decision.

2. To schedule your campaign, press the **Schedule** button, specify the day and time you'd like your email to send, and **Confirm**.
...
<img height="200" src="/images/email-campaigns/unschedule-campaign.png" />
...
<img height="200" src="/images/email-campaigns/delete-duplicate.png" />
...
<Warning>
  Privy only recommends duplicating campaigns when necessary. It's a best practice to [save templates](https://help.privy.com/docs/learn/email-campaigns/email-templates) and start from a fresh template each time you create a new campaign.
</Warning>
