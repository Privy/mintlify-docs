...
* Once you select your template, you can [use our drag and drop editor](https://privy.mintlify.app/docs/learn/email-campaigns/email-templates) to customize the design.
...
If you're using a [Coupon merge tag](https://privy.mintlify.app/docs/learn/content/coupon-codes#email-campaigns) in your Campaign, make sure that you attach your coupon code here. Click the 'edit' icon, select the desired coupon from the dropdown menu, and click **Done** to save your changes.
...
<Warning>
  Privy only recommends duplicating campaigns when necessary. It's a best practice to [save templates](https://privy.mintlify.app/docs/learn/email-campaigns/email-templates) and start from a fresh template each time you create a new campaign.
</Warning>
